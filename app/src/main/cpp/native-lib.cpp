...
Java_com_shenyutao_myapplication_ScreenLive_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_shenyutao_myapplication_ScreenLive_sendData(JNIEnv *env, jobject thiz, jbyteArray data_,
